  ...
  return (
    <div id="projects" className="min-h-screen flex items-center bg-gray-50 px-4 py-10 text-gray-800">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold mb-6 text-center">My <span className="text-blue-500">Projects</span></h1>
        <p className="text-center text-gray-500 mb-10">Berikut adalah beberapa proyek yang telah saya kerjakan:</p>

        <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <div
              key={index}
              className="bg-white border border-blue-400 rounded-2xl p-6 shadow-md hover:shadow-xl active:shadow-xl transition-all duration-300"
            >
              ...
              <div className="flex items-center space-x-4">
                ...
                <a href={project.repo} target="_blank" className="text-gray-700 hover:text-black flex items-center gap-1">
